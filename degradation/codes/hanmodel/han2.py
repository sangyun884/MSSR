...
class HAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        # define head module
        modules_head = [conv(3, n_feats, kernel_size, stride=1), conv(n_feats, n_feats, kernel_size, stride=1)]
        ...
        modules_body +=[conv(n_feats, n_feats, kernel_size)] # Down-sample
        ...
        modules_tail = [conv(n_feats, n_feats, kernel_size, stride=2), conv(n_feats, n_feats, kernel_size, stride=2), conv(n_feats, 3, kernel_size)] # Upsample block removed
        ...
        self.csa = CSAM_Module(n_feats, args.neptune)
